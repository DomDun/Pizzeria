        ...
        public void AddOrder(OrderData order)
        {
            ...
            try
            {
                using (SqlConnection connection = new SqlConnection(_connectionString))
                {
                    ...
                    string getLastOrderIdCommandText = $"SELECT IDENT_CURRENT ('Orders') AS [OrderId]";
                    ...
                    sqlDataReader.Read();
                    int orderId = int.Parse(sqlDataReader["OrderId"].ToString());
                    sqlDataReader.Close();
            ...
            // todo: zrobić zapisywanie do sqla.
            catch (Exception ex)
            {
